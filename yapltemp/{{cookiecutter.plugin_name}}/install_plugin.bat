:: mentary YASARA plugin installer
::
...
if not exist "%YASARA_HOME%\bab\"
    if not exist "%YASARA_HOME%\cif\"
        if not exist "%YASARA_HOME%\plg\"
            if not exist "%YASARA_HOME%\yasara" (
...
if exist "%YASARA_HOME%\plg\{{cookiecutter.plugin_name}}.py (
...
copy "{{cookiecutter.plugin_name}}\{{cookiecutter.plugin_name}}.py" "%YASARA_HOME%\plg\"
